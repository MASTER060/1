    ...
    internal class DlnaDirectoryRequestHandler : BaseRequestHandler {
        ...
        public override void Handle(HttpListenerRequest request, HttpListenerResponse response) {
            ...
            if (!string.IsNullOrEmpty(rootDirectory)) {
                ...
                foreach (var directory in directoriesInfo.Where(DlnaConfigurate.CheckAccess)) {
                ...
                foreach (var file in filesInfo.Where(DlnaConfigurate.CheckAccess)) {
                ...
                Log.Debug(m => m("Directory Not Found: {0}", rootDirectory));
