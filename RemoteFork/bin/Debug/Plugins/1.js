/*! magcore-app-youtube: v2.1.1 (webpack: v1.13.1) */ ! function(e) {
    function t(i) {
    ...
    N.addListener("content:changed", function() {
        ...
        this.show(), d.length && d[T].focus(), N.channelId = e.id, N.getInfo({}, function(e, t) {
            t.background = t.background.split("=")[0] + "=w1920-fcrop64=1,00000000ffffffff-nd-c0xffffffff-rj-k-no", f.style.backgroundImage = "url(" + t.background + ")", g.style.backgroundImage = "url(" + t.icon + ")", m.innerHTML = t.title, N.emit("content:changed")
        })
    }, e.exports = h
}, function(e, t, n) {
    "use strict";
    ...
    function i(e, t) {
        ...
        N || (t ? (N = !0, d.getPage({
            ...
            t || 0 === i.length ? (++x, ++I, f[e].model.filter({
                channel: {
                    id: "!",
                    title: ""
                }
            ...
            }], f[e].viewIndex = null, f[e].renderView(0), f[e].focusIndex(0), f[e].$title.innerHTML = "", T = n, E = e, g = n, f[T].$node.style.top = w, f[E].$node.style.top = b, f[g].focus()) : (++x, ++I, T = n, E = e, g = n, f[e].data = i, f[e].viewIndex = null, f[e].renderView(0), f[e].focusIndex(0), f[e].emit("view:ready"))
        })))
    }
    var r = n(1),
        o = n(2),
        ...
        e.exports = function(e) {
            ...
            i.prototype.parse = function(e, t, n) {
                ...
                if (!E[p] && (S || p && !x[p])) {
                    ...
                    if (!L)
                        for (var O = this.hostname.split(/\./), C = 0, $ = O.length; $ > C; C++) {
                            var D = O[C];
                            if (D && !D.match(b)) {
                    ...
                    this.hostname.length > y ? this.hostname = "" : this.hostname = this.hostname.toLowerCase(), L || (this.hostname = l.toASCII(this.hostname));
                    var U = this.port ? ":" + this.port : "",
                        H = this.hostname || "";
                    this.host = H + U, this.href += this.host, L && (this.hostname = this.hostname.substr(1, this.hostname.length - 2), "/" !== s[0] && (s = "/" + s))
                }
                if (!T[f])
            ...
            (function(t, i) {
                ...
                function s(e) {
                    return I = I || n(1), O.call(s, this) || this instanceof I ? (this._writableState = new a(e, this), this.writable = !0, e && ("function" == typeof e.write && (this._write = e.write), "function" == typeof e.writev && (this._writev = e.writev)), void A.call(this)) : new s(e)
                }
                ...
                function u(e, t, n) {
                    return e.objectMode || e.decodeStrings === !1 || "string" != typeof t || (t = L.from(t, n)), t
                }
                ...
                "function" == typeof Symbol && Symbol.hasInstance && "function" == typeof Function.prototype[Symbol.hasInstance] ? (O = Function.prototype[Symbol.hasInstance], Object.defineProperty(s, Symbol.hasInstance, {
                    value: function(e) {
                        return O.call(this, e) ? !0 : e && e._writableState instanceof a
                    }
                })) : O = function(e) {
            ...
            (function(t) {
                function i(e, t, n) {
                    return "function" == typeof e.prependListener ? e.prependListener(t, n) : void(e._events && e._events[t] ? L(e._events[t]) ? e._events[t].unshift(n) : e._events[t] = [n, e._events[t]] : e.on(t, n))
                }
                ...
                function o(e) {
                    return _ = _ || n(1), this instanceof o ? (this._readableState = new r(e, this), this.readable = !0, e && "function" == typeof e.read && (this._read = e.read), void O.call(this)) : new o(e)
                }
                ...
                var _, k = n(12),
                    L = n(21);
                o.ReadableState = r;
                var O, $ = (n(7).EventEmitter, function(e, t) {
                ...
                var q, V = n(45);
                P.inherits(o, O), o.prototype.push = function(e, t) {
            ...
            (function(e) {
                ! function(t) {
                    ...
                    function l(e, t) {
                        ...
                        L.apply(this), this._parser = new i(e, t), this.writable = !0, this.readable = !0;
                        var n = this;
            ...
            (function(e, i) {
                ...
                ! function(o) {
                    ...
                    function l(e, t) {
                        var n = e.split("@"),
                            i = "";
                        n.length > 1 && (i = n[0] + "@", e = n[1]), e = e.replace(L, ".");
                        var r = e.split("."),
                            o = s(r, t).join(".");
                        return i + o
                    }
    ...
    function i(e) {
        var t, n, i, r, o, a, s, l, c, u, d, h, p, f, m, g = [];
        for (c = e.split('<li class="yt-shelf-grid-item'), p = 0; p < c.length; p++)
            if (h = c[p], -1 !== h.indexOf("yt-lockup-content")) {
                if (-1 !== h.indexOf("yt-lockup-playlist")) f = "playlist";
                    ...
                    if (-1 === h.indexOf("yt-lockup-video")) continue;
                    f = "video"
                }
                u = h.indexOf('="https://i.ytimg') + 2, d = h.indexOf('"', u), s = h.substring(u, d), u = h.indexOf(' data-ytid="') + 12, d = h.indexOf('"', u), l = h.substring(u, d), "playlist" === f && (u = h.indexOf('" dir="ltr">') + 12, d = h.indexOf("</a><span", u), a = h.substring(u, d), -1 !== h.indexOf('<div class="yt-lockup-byline ">YouTube</div>') && (l = ""), u = h.indexOf('<a href="/watch?v=') + 9, d = h.indexOf('"', u), m = h.substring(u, d).replace("&amp;", "&"), u = h.indexOf('" dir="ltr">') + 12, d = h.indexOf("<", u), n = h.substring(u, d), g.push({
                    value: 1,
                    playlistId: m,
                    channel: {
                        title: n,
                ...
                })), "video" === f && (u = h.indexOf('data-context-item-id="') + 22, d = h.indexOf('"', u), t = h.substring(u, d), u = h.indexOf('<span class="video-time" aria-hidden="true">') + 44, d = h.indexOf("</span>", u), i = h.substring(u, d), u = h.indexOf('<ul class="yt-lockup-meta-info"><li>') + 36, d = h.indexOf(" ", u), r = h.substring(u, d), u = h.indexOf("</li><li>", u) + 9, d = h.indexOf("</li></ul></div>", u), o = h.substring(u, d), u = h.indexOf('" dir="ltr">') + 12, d = h.indexOf("</a><span", u), a = h.substring(u, d), u = h.indexOf(' data-ytid="'), u = h.indexOf(">", u) + 1, d = h.indexOf("</a>", u), n = h.substring(u, d), g.push({
                    value: 1,
                    id: t,
                    channelTitle: n,
                    duration: i,
    ...
    function i(e) {
        var t, n, i, r, o, a, s, l, c, u, d, h, p, f, m, g, v, y = [];
        for (m = e.split('<div class="yt-lockup yt-lockup-tile '), g = 0; g < m.length; g++)
            if (v = m[g], -1 !== v.indexOf("yt-lockup-content")) {
                if (-1 !== v.indexOf("yt-lockup-playlist")) t = "playlist";
                    ...
                    if (-1 === v.indexOf("yt-lockup-video")) continue;
                    t = "video"
                }
                p = v.indexOf('="https://i.ytimg') + 2, f = v.indexOf('"', p), l = v.substring(p, f), p = v.indexOf('" dir="ltr">') + 12, f = v.indexOf("</a><span", p), s = v.substring(p, f), p = v.indexOf(' data-ytid="') + 12, f = v.indexOf('"', p), c = v.substring(p, f), "playlist" === t && (-1 !== v.indexOf('<div class="yt-lockup-byline ">YouTube</div>') && (c = ""), p = v.indexOf('<a href="/watch?v=') + 9, f = v.indexOf('"', p), u = v.substring(p, f).replace("&amp;", "&"), p = v.indexOf('" dir="ltr">') + 12, f = v.indexOf("<", p), i = v.substring(p, f), y.push({
                    value: 1,
                    playlistId: u,
                    channel: {
                        title: i,
                ...
                })), "video" === t && (p = v.indexOf('href="/watch?v=') + 15, f = v.indexOf('"', p), n = v.substring(p, f), p = v.indexOf('<span class="video-time" aria-hidden="true">') + 44, f = v.indexOf("</span>", p), r = v.substring(p, f), p = v.indexOf('<ul class="yt-lockup-meta-info"><li>') + 36, f = v.indexOf("</li><li>", p), a = v.substring(p, f), p = v.indexOf("</li><li>", p) + 9, f = v.indexOf(" ", p), o = v.substring(p, f), p = v.indexOf(' data-ytid="'), p = v.indexOf(">", p) + 1, f = v.indexOf("</a>", p), i = v.substring(p, f), y.push({
                    value: 1,
                    id: n,
                    channelTitle: i,
                    duration: r,
                ...
                })), "channel" === t && (p = v.indexOf('="https://yt') + 2, f = v.indexOf('"', p), l = v.substring(p, f), p = v.indexOf('" dir="ltr">') + 12, f = v.indexOf("<span", p), s = v.substring(p, f), p = v.indexOf('"yt-lockup-meta-info"><li>') + 26, f = v.indexOf(" ", p), d = v.substring(p, f), p = v.indexOf('yt-subscriber-count" title="') + 28, f = v.indexOf('"', p), h = v.substring(p, f), y.push({
                    value: 1,
                    id: c,
                    title: s,
                    icon: l,
    ...
    p.addListener("show", function(e) {
        ...
        switch (e.code) {
            ...
            case m.back:
                ...
                break;
            case m.stop:
                s.stop(), s.isPause = !1, c.emit("click"), E.hide(), window.ppPanelPlayer.classList.remove("transparent"), o.show();
                break;
            case m.down:
                break;
            case m.playPause:
